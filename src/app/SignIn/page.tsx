        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="form-control">
            ...
            <label className="label mt-1">
              <a
                href="#"
                className="label-text-alt text-gray-400 hover:text-white transition-colors"
              >
                Forgot password?
              </a>
            </label>
          ...
          <div className="form-control mt-8">
            <button
              type="submit"
              className="btn w-full bg-linier-to-r from-primary to-secondary text-black-500 border-0 hover:scale-[1.02] transition-transform duration-300 shadow-lg shadow-primary/30"
            >
              Sign In
            </button>
          </div>
